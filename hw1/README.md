...
| 樣本數     | 範例                                                         |
| ---------- | ------------------------------------------------------------ |
| 10 張示例  | <img src="static/avg_result_10.jpg"  alt="平均值去噪結果（10 張）"  width="800"/>   |
| 140 張示例 | <img src="static/avg_result_140.jpg" alt="平均值去噪結果（140 張）" width="800"/> |

#### 中位數去噪

| 樣本數     | 範例                                                                 |
| ---------- | -------------------------------------------------------------------- |
| 10 張示例  | <img src="static/median_result_10.jpg"  alt="中位數去噪結果（10 張）"  width="800"/> |
| 140 張示例 | <img src="static/median_result_140.jpg" alt="中位數去噪結果（140 張）" width="800"/> |

#### 討論
 
 - 10 張：經過處理後，放大觀看噪點已明顯減少
 - 140 張：與 10 張對比，明顯已經幾乎看不出噪點